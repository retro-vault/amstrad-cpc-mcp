...
/*#
    ...
    Locally altered only for const-correct C++ pointer conversion. See
    lib/chips/UPSTREAM.md.
...
void am40010_init(am40010_t* ga, const am40010_desc_t* desc) {
    ...
    ga->ram = (const uint8_t*) desc->ram.ptr;
    ga->fb = (uint8_t*) desc->framebuffer.ptr;
