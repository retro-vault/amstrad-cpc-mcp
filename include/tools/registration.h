...
// Register CPCEMU DSK insertion, ejection and drive diagnostics.
void register_disk_tools(mcp::tool_registry &registry,
                         cpc::machine &target);

// Register the CPC6128 CP/M 2.2 boot workflow.
void register_cpm_tool(mcp::tool_registry &registry,
                       cpc::machine &target,
...
//
// Register the persistent PNG screenshot tool.
//
void register_capture_tools(mcp::tool_registry &registry,
                            cpc::machine &target);

// Register AY-3-8912 playback and WAV recording tools.
